...
class Portfolios2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Portfolios 2', 'acuasafe' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'portfolios2',
			[
				'label' => esc_html__( 'Portfolios 2', 'acuasafe' ),
			]
		);
		$this->add_control(
			'sec_class',
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .gallery-section .sortable-masonry .filters .filter-tabs li.active:after' => 'background: {{VALUE}} !important',
				),
			)
		);	
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .gallery-section .sortable-masonry .filters .filter-tabs li.active:before' => 'background: {{VALUE}} !important',
				),
			)
		);			
		$this->add_control(
...
//========== Button Two with Background ===================================
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .gallery-section .sortable-masonry .filters .filter-tabs li:after' => 'background: {{VALUE}} !important',
				), 
			)
		);	
		$this->add_control(
			...
			array(
				...
				'type'         => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .gallery-section .sortable-masonry .filters .filter-tabs li:before' => 'background: {{VALUE}} !important',
				),
			)
		);		
		$this->add_control(
	...
	protected function render() {
		...
		<?php 
			...
			<div class="col-lg-<?php echo esc_attr(get_post_meta( get_the_id(), 'meta_number', true ));?> col-md-6 col-sm-12 masonry-item small-column all <?php echo esc_attr($term_slug); ?>">
