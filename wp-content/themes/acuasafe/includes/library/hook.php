 ...
 */
//acuasafe_load_default_hooks
function acuasafe_load_default_hooks() {

	$config = acuasafe_WSH()->config( 'default' );
...
/**
 * [acuasafe_main_header_area description]
 *
 * @return [type] [description]
 */

//acuasafe_main_header_area
function acuasafe_main_header_area() {
	...
	//need to change
	if ( $header == 'header_v1' ) {
		acuasafe_template_load( 'templates/header/default-header.php' );
	} elseif ( $header == 'header_v2' ) {
		acuasafe_template_load( 'templates/header/header_v2.php' );
	} elseif ( $header == 'header_v3' ) {
		acuasafe_template_load( 'templates/header/header_v3.php' );
	} elseif ( $header == 'header_v4' ) {
		acuasafe_template_load( 'templates/header/header_v4.php' );
	} elseif ( $header == 'header_v5' ) {
		acuasafe_template_load( 'templates/header/header_v5.php' );
	} else {
		acuasafe_template_load( 'templates/header/default-header.php' );
	}
}
...
/**
 * [acuasafe_main_footer_area description]
 *
 * @return [type] [description]
 */
//acuasafe_main_footer_area
function acuasafe_main_footer_area() {
	...
	//need to change
	if ( $footer == 'footer_v1' ) {
		acuasafe_template_load( 'templates/footer/default-footer.php' );
	} elseif ( $footer == 'footer_v2' ) {
		acuasafe_template_load( 'templates/footer/footer_v2.php' );
	} else {
		acuasafe_template_load( 'templates/footer/default-footer.php' );
	}
}
...
/**
 * [acuasafe_sidebar description]
 *
 * @return [type] [description]
 */
//acuasafe_sidebar
function acuasafe_sidebar( $data ) {

	acuasafe_template_load( 'templates/sidebar.php', compact( 'data' ) );
}

/**
 * [acuasafe_banner description]
 *
 * @return [type] [description]
 */
//acuasafe_banner
function acuasafe_banner( $data ) {

	acuasafe_template_load( 'templates/banner/banner.php', compact( 'data' ) );
