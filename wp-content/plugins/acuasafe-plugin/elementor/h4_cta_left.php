 ...
 * @since 1.0.0
 */
class H4_Cta_Left extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'H4 Cta Left', 'acuasafe' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'h4_cta_left',
			[
				'label' => esc_html__( 'H4 Cta Left', 'acuasafe' ),
			]
		);
		$this->add_control(
			'sec_class',
		...
		$this->start_controls_section(
			'text_settings',
			array(
				'label' => __( 'Circle Setting', 'acuasafee' ),
		...
		$this->add_control(
			...
			array(
				...
				'default' => 'show',
				'selectors' => array(
					'{{WRAPPER}}  .cta-section-home4 .image-box .text' => 'display: {{VALUE}} !important',
				),   
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}}  .cta-section-home4 .image-box .text' => 'background: {{VALUE}} !important',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default' => 'show',
				'selectors' => array(
					'{{WRAPPER}} .cta-section-home4 .image-box .text h2' => 'display: {{VALUE}} !important',
				),   
			) 
		);  
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .cta-section-home4 .image-box .text h2' => 'text-align: {{VALUE}} !important',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .cta-section-home4 .image-box .text h2' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .cta-section-home4 .image-box .text h2' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',
				), 
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .cta-section-home4 .image-box .text h2',
			)
		); 
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .cta-section-home4 .image-box .text h2' => 'color: {{VALUE}} !important',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default' => 'show',
				'selectors' => array(
					'{{WRAPPER}} .cta-section-home4 .image-box .text h5' => 'display: {{VALUE}} !important',
				), 
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .cta-section-home4 .image-box .text h5' => 'text-align: {{VALUE}} !important',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
			'{{WRAPPER}} .cta-section-home4 .image-box .text h5' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',		
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
			'{{WRAPPER}} .cta-section-home4 .image-box .text h5' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',		
				), 
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .cta-section-home4 .image-box .text h5',
			)
		); 
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .cta-section-home4 .image-box .text h5' => 'color: {{VALUE}} !important',
				),
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 image-column">
                            <div class="image-box">
                                <div class="shape">
                                    ...
                                    <div class="shape-1 rotate-me" style="background-image: url(<?php echo wp_get_attachment_url($settings['bgimg2']['id']);?>);">
									<?php else :?>	
									<div class="noimage">
									<?php endif;?>
									</div>
									<?php  if ( esc_url($settings['bgimg3']['id']) ) : ?>
                                    <div class="shape-2 rotate-me" style="background-image: url(<?php echo wp_get_attachment_url($settings['bgimg3']['id']);?>);">
									<?php else :?>	
									<div class="noimage">
									<?php endif;?>
									</div>
