...
<header class="main-header home-4">
	...
	<?php if( $options->get( 'top_header_show_v4' ) ):?>
	<div class="header-top">
		<div class="top-inner clearfix">
			<div class="left-column pull-left">
				<ul class="info clearfix">
					<?php if( $options->get( 'time_title_v4')):?>
					<li><i class="far fa-clock"></i><?php echo wp_kses( $options->get( 'time_title_v4'), $allowed_html ); ?></li>
					<?php endif; ?>
					<?php if( $options->get( 'address_title_v4')):?>
					<li><i class="far fa-map-marker-alt"></i><?php echo wp_kses( $options->get( 'address_title_v4'), $allowed_html ); ?></li>
					<?php endif; ?>
					<?php if( $options->get( 'phone_v4')):?>
					<li><i class="fas fa-phone"></i><span><?php echo wp_kses( $options->get( 'phone_title_v4'), $allowed_html ); ?> </span><a href="tel:#"><?php echo wp_kses( $options->get( 'phone_v4'), $allowed_html ); ?></a></li>
					<?php endif; ?>
				</ul>
			</div>
	...
	<div class="header-lower">
		<div class="outer-box">
			<div class="logo-box">
				<figure class="logo">
					<?php echo acuasafe_logo( $logo_type, $image_logo, $logo_dimension, $logo_text, $logo_typography ); ?>
				</figure>
			</div>
			...
			<ul class="nav-right">
							...
							<div class="form-container">
								<form method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>">
									<div class="form-group">
										<input type="search" name="s" value="" placeholder="<?php echo wp_kses( $options->get( 'search_text_v4'), $allowed_html ); ?>" required="">
				...
				<?php if( $options->get( 'quote_show_v4' ) ):?>
					...
					<li class="btn-box">
						<a href="<?php echo wp_kses( $options->get( 'quote_link_v4'), $allowed_html ); ?>" class="theme-btn btn-one"><?php echo wp_kses( $options->get( 'quote_v4'), $allowed_html ); ?></a>
					</li>
					<?php endif; ?>
				<?php endif; ?>
...
<div class="mobile-menu">
	...
	<nav class="menu-box">
		<div class="nav-logo">
			<?php echo acuasafe_logo( $logo_type, $image_logo2, $logo_dimension2, $logo_text, $logo_typography ); ?>
		</div>
