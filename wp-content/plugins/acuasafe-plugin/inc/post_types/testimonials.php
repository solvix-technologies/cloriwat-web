...
namespace ACUASAFEPLUGIN\Inc\Post_Types;

use ACUASAFEPLUGIN\Inc\Abstracts\Post_Type;
 ...
 *
 * @version  2.6.0
 * @package  ACUASAFEPLUGIN/Abstracts
 * @category Abstract Class
 * @author   Wptech
 */
class Testimonials extends Post_Type {

	protected $post_type = 'acuasafe_testimonials';
	...
	public static function init() {
		...
		self::instance()->singular  = esc_html__( 'Testimonial', 'wpacuasafe' );
		self::instance()->plural    = esc_html__( 'Testimonials', 'wpacuasafe' );
