 ...
 * @since 1.0.0
 */
class H4_About_Right extends Widget_Base {
	...
	public function get_name() {
		return 'acuasafe_h4_about_right';
	}
	...
	public function get_title() {
		return esc_html__( 'H4 About Right', 'acuasafe' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'h4_about_right',
			[
				'label' => esc_html__( 'H4 About Right', 'acuasafe' ),
			]
		);
		$this->add_control(
			'sec_class',
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 image-column">
                        <div class="image-box">
                            ...
                            <div class="image-shape rotate-me" style="background-image: url(<?php echo wp_get_attachment_url($settings['bgimg']['id']);?>);">
							<?php else :?>	
							<div class="noimage">
							<?php endif;?>
							</div>
