 ...
 * @since 1.0.0
 */
class Footer_Widget3 extends Widget_Base {
	...
	public function get_name() {
		return 'acuasafe_footer_widget3';
	}
	...
	public function get_title() {
		return esc_html__( 'Footer Widget 3', 'acuasafe' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'footer_widget3',
			[
				'label' => esc_html__( 'Footer Widget 3', 'acuasafe' ),
			]
		);
		$this->add_control(
			'sec_class',
