 ...
 * @since 1.0.0
 */
class Footer_Widget4 extends Widget_Base {
	...
	public function get_name() {
		return 'acuasafe_footer_widget4';
	}
	...
	public function get_title() {
		return esc_html__( 'Footer Widget 4', 'acuasafe' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'footer_widget4',
			[
				'label' => esc_html__( 'Footer Widget 4', 'acuasafe' ),
			]
		);
		$this->add_control(
			'sec_class',
