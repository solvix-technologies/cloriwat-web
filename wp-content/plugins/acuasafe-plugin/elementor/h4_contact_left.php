 ...
 * @since 1.0.0
 */
class H4_Contact_Left extends Widget_Base {
	...
	public function get_name() {
		return 'acuasafe_h4_contact_left';
	}
	...
	public function get_title() {
		return esc_html__( 'H4 Contact Left', 'acuasafe' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'h4_contact_left',
			[
				'label' => esc_html__( 'H4 Contact Left', 'acuasafe' ),
			]
		);
		$this->add_control(
			'sec_class',
		...
		$this->add_control(
			...
			array(
				...
				'default' => 'show',
				'selectors' => array(
					'{{WRAPPER}} .contact-section-home4.one .sec-title-two h5:before' => 'display: {{VALUE}} !important',
				),   
			) 
		);  
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .contact-section-home4.one .sec-title-two h5:before' => 'background: {{VALUE}} !important',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default' => 'show',
				'selectors' => array(
					'{{WRAPPER}} .contact-section-home4.one .sec-title-two h5:after' => 'display: {{VALUE}} !important',
				),    
			) 
		);  
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .contact-section-home4.one .sec-title-two h5:after' => 'background: {{VALUE}} !important',
				), 
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default' => 'show',
				'selectors' => array(
					'{{WRAPPER}} .contact-section-home4.one .sec-title-two h5' => 'display: {{VALUE}} !important',
				), 
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .contact-section-home4.one .sec-title-two h5' => 'text-align: {{VALUE}} !important',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
			'{{WRAPPER}} .contact-section-home4.one .sec-title-two h5' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',		
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
			'{{WRAPPER}} .contact-section-home4.one .sec-title-two h5' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',		
				), 
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .contact-section-home4.one .sec-title-two h5',
			)
		); 
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .contact-section-home4.one .sec-title-two h5' => 'color: {{VALUE}} !important',
				),
		...
		$this->add_control(
			...
			array(
				...
				'default' => 'show',
				'selectors' => array(
					'{{WRAPPER}} .contact-section-home4.one .sec-title-two h2' => 'display: {{VALUE}} !important',
				),   
			) 
		);  
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .contact-section-home4.one .sec-title-two h2' => 'text-align: {{VALUE}} !important',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .contact-section-home4.one .sec-title-two h2' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .contact-section-home4.one .sec-title-two h2' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',
				), 
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .contact-section-home4.one .sec-title-two h2',
			)
		); 
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .contact-section-home4.one .sec-title-two h2' => 'color: {{VALUE}} !important',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default' => 'show',
				'selectors' => array(
					'{{WRAPPER}} .contact-section-home4.one .sec-title-two p' => 'display: {{VALUE}} !important',
				), 
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'toggle' => true,
				'selectors' => array(
					'{{WRAPPER}} .contact-section-home4.one .sec-title-two p' => 'text-align: {{VALUE}} !important',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'condition'    => array( 'show_section_title_text' => 'show' ),
				'selectors' => array(
					'{{WRAPPER}} .contact-section-home4.one .sec-title-two p' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',
				), 
			)
		); 
		...
		$this->add_control(
			...
			array(
				...
				'condition'    => array( 'show_section_title_text' => 'show' ),
				'selectors' => array(
					'{{WRAPPER}} .contact-section-home4.one .sec-title-two p' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'condition'    => array( 'show_section_title_text' => 'show' ),
				'label'    => __( 'Typography', 'acuasafe' ),
				'selector' => '{{WRAPPER}} .contact-section-home4.one .sec-title-two p',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .contact-section-home4.one .sec-title-two p' => 'color: {{VALUE}} !important',
				),
			)
		);
