...
return array(
	'id'     => 'acuasafe_header_settings',
	'title'  => esc_html__( "Acuasafe Header Settings", "konia" ),
	'fields' => array(
		array(
			'id'      => 'header_source_type',
			'type'    => 'button_set',
			'title'   => esc_html__( 'Header Source Type', 'acuasafe' ),
			'options' => array(
		...
		array(
			...
			'type'     => 'select',
			'title'    => __( 'Template', 'acuasafe-plugin' ),
			'data'     => 'posts',
			'args'     => [
		...
		array(
			...
			'type'     => 'image_select',
			'title'    => esc_html__( 'Choose Header Styles', 'acuasafe' ),
			'options'  => array(
				'header_v1' => array(
					'alt' => 'Header Style 1',
