	...
	$this->add_control(
            'style', 
				[
					...
					'default' => 'one',
					'options' => array(
						'one' => esc_html__( 'Style One', 'acuasafe' ),
						'two' => esc_html__( 'Style Two', 'acuasafe' ),
					),
				]
		);
    ...
    $this->add_control(
            'owl_dot', 
                 array(
                    ...
                    'default' => '1',
                    'options' => array(
                        '1' => esc_html__( 'Nav Arrow', 'acuasafe' ),
        ...
        $this->add_control(
            'awl_lazy', 
                array(
                    ...
                    'default' => '1',
                    'options' => array(
                        '1' => esc_html__( 'Lazy Load', 'acuasafe' ),
                        '2' => esc_html__( 'Disable Lazy Load', 'acuasafe' ),
                                                   ...
                                                   <div class="product_bottom mr_bottom"> 
													 ...
													 <!-- Product Rating   --> 		 																  
															...
															<?php if($settings['show_rating']){ ?>					  
																  <div class="mr_review_number"> <?php echo mr_product_rating(); ?> </div>  
															<?php } ?> 			  
