 ...
 * @since 1.0.0
 */
class H1_Shop extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'H1 Shop', 'acuasafe' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'h1_shop',
			[
				'label' => esc_html__( 'H1 Shop', 'acuasafe' ),
			]
		);
		$this->add_control(
			'sec_class',
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .shop-section .shop-block-one .inner-box .lower-content h4 a' => 'text-align: {{VALUE}} !important',
				),
			)
		);
	...
	$this->add_control(
		...
		$this->start_controls_section(
			'text_settings2',
			array(
				'label' => __( 'Text Setting Two', 'acuasafee' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'condition'    => array( 'show_text2' => 'show' ),
				'selectors' => array(
					'{{WRAPPER}} .shop-section .shop-block-one .inner-box .lower-content p' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .shop-section .shop-block-one .inner-box .lower-content p:hover' => 'color: {{VALUE}} !important',
				),
			)
		);
	...
	protected function render() {
		...
		<section class="shop-section centred <?php echo esc_attr($settings['sec_class']);?>">
