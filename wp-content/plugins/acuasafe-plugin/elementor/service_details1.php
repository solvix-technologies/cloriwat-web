 ...
 * @since 1.0.0
 */
class Service_Details1 extends Widget_Base {
	...
	public function get_name() {
		return 'acuasafe_service_details1';
	}
	...
	public function get_title() {
		return esc_html__( 'Service Details 1', 'acuasafe' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'service_details1',
			[
				'label' => esc_html__( 'Service Details 1', 'acuasafe' ),
			]
		);
		$this->add_control(
			'sec_class',
		...
		$this->add_control(
			...
			array(
				...
				'default' => 'show',
				'selectors' => array(
					'{{WRAPPER}} .service-details-content h2' => 'display: {{VALUE}} !important',
				),   
			) 
		);  
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .service-details-content h2' => 'text-align: {{VALUE}} !important',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .service-details-content h2' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',
				),
			)
		);  
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .service-details-content h2' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',
				),  
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .service-details-content h2',
			)
		); 
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .service-details-content h2' => 'color: {{VALUE}} !important',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default' => 'show',
				'selectors' => array(
					'{{WRAPPER}} .service-details-content .content-one .text p' => 'display: {{VALUE}} !important',
				), 
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'toggle' => true,
				'selectors' => array(
					'{{WRAPPER}} .service-details-content .content-one .text p' => 'text-align: {{VALUE}} !important',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'condition'    => array( 'show_section_title_text' => 'show' ),
				'selectors' => array(
					'{{WRAPPER}} .service-details-content .content-one .text p' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',
				), 
			)
		); 
		...
		$this->add_control(
			...
			array(
				...
				'condition'    => array( 'show_section_title_text' => 'show' ),
				'selectors' => array(
					'{{WRAPPER}} .service-details-content .content-one .text p' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',
				), 
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'condition'    => array( 'show_section_title_text' => 'show' ),
				'label'    => __( 'Typography', 'acuasafe' ),
				'selector' => '{{WRAPPER}} .service-details-content .content-one .text p',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .service-details-content .content-one .text p' => 'color: {{VALUE}} !important',
				),
			)
		);
